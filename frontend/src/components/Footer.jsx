    ...
    <div>
      ...
      <form onSubmit={submit} className="flex mt-3 gap-2">
        ...
        <button
          type="submit"
          disabled={busy}
          className="bg-gold text-brand text-sm font-bold px-4 rounded-lg whitespace-nowrap disabled:opacity-60"
        >
          {busy ? "..." : "Subscribe"}
        </button>
      </form>
  ...
  return (
    <footer className="bg-brand text-white mt-12">
      ...
      <div className="container py-12 grid gap-8 md:grid-cols-4">
        ...
        {/* Company */}
        <div>
          <b className="text-gold">COMPANY</b>
        ...
        {/* Customer Service */}
        <div>
          <b className="text-gold">CUSTOMER SERVICE</b>
      ...
      <div className="border-t border-white/10">
        <div className="container py-8 grid gap-3 sm:flex sm:items-center sm:justify-between">
      ...
      {/* Bottom Footer */}
      <div className="border-t border-white/10">
        <div className="container py-4 text-xs text-white/60 flex flex-col sm:flex-row justify-between gap-2">
          <span>
